...
from .clock import clock_daemon

from .interfaces.manager import get_interface_manager
from .notificationbox import NotificationListView # noqa: F401
...
class ControlPanel(Gtk.Box):
	...
	def __init__(self):
		...
		from .window_switcher import window_switcher
